...
class supsystic_promoPts extends modulePts {
	...
	public function init() {
		...
		dispatcherPts::addAction('discountMsg', array($this, 'getDiscountMsg'));
	...
	public function getDiscountMsg() {
		if($this->isPro()
			&& framePts::_()->getModule('options')->getActiveTab() == 'license'
			&& framePts::_()->getModule('license')
			&& framePts::_()->getModule('license')->getModel()->isActive()
		) {
